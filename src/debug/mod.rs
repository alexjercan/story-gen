        ...
        match window {
            ...
            EguiWindow::Resources => {
                let mut resources: Vec<_> = type_registry
                    ...
                    .map(|registration| {
                        (registration.short_name().to_owned(), registration.type_id())
                    })
                    .collect();
                ...
                for (resource_name, type_id) in resources {
                    ...
                    if ui.selectable_label(selected, &resource_name).clicked() {
                        *self.selection = InspectorSelection::Resource(type_id, resource_name);
                    }
                }
            }
            EguiWindow::Assets => {
                ...
                for (asset_name, asset_type_id, reflect_asset) in assets {
                    let mut handles: Vec<_> = reflect_asset.ids(self.world).collect();
                    handles.sort();
